...
description: 零维团队工程开发规范入口。用于零维团队项目中的代码实现、架构/方案设计、Spring Boot、FastAPI、Soybean Admin、API 设计、安全、测试、注释/Javadoc/docstring/TSDoc、数据库变更、依赖变更、Git 分支/提交/PR/MR、代码审查、Bug 修复、重构和工程规范检查；根据当前技术栈和变更类型按需读取 references/ 下的相关规范。
---
...
| 注释、Javadoc、docstring、TSDoc、类/方法/参数/返回值说明、字段说明、公共 API 文档 | `references/comment-standard.md` |
...
- 测试实现：读测试规范和对应技术栈规范。
- 代码实现 / 重构 / Review 涉及新增或修改公共类、接口、方法、类型、字段时：读注释规范和对应技术栈规范。
